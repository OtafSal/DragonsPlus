package com.sorensmods.dragonsplus;
...
public class DragonsPlus
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "dragonsplus";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();



    public DragonsPlus(FMLJavaModLoadingContext context)
    {
    ...
    public static class ClientModEvents
    {
        ...
        {
            EntityRenderers.register(ModEntities.ModEnderDragonRegister.get(), ModEnderDragonRenderer::new);
