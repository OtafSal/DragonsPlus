...
public class DragonFollowOwnerGoal extends Goal
{
    ...
    private final double liftoffPower;
    private final double jumpPower;

    public DragonFollowOwnerGoal(TamableAnimal dragon, double speedModifier, float startDistance, float stopDistance, float teleportDistance, double liftoffPower, double jumpPower)
    {
        this.dragon = dragon;
        ...
        this.liftoffPower = liftoffPower;
